...
public class PayRestController {
	...
	public String kakaoPay(@RequestParam Map<String, String> params,HttpSession session) throws Exception 
	{
        ...
        requestBodyMap.put("approval_url", "http://127.0.0.1:8080/pay/kakaoPay/success"); //결제 성공시 넘어갈 url
        requestBodyMap.put("cancel_url", "http://127.0.0.1:8080/pay/kakaoPay/cancel"); //결제 취소시 넘어갈 url
        requestBodyMap.put("fail_url", "http://127.0.0.1:8080/pay/kakaoPay/fail"); //결제 실패시 넘어갈 url
