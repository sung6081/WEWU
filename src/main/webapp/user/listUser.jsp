        ...
        <div class="row row-no-margin">
            <div class="page-header text-info">
                ...
                <div class="col-md-6 col-right">
                    <form class="form-inline search-form" name="detailForm">
                        <div class="form-group">
                            <select class="form-control" name="searchCondition" style="height: 35px; font-size: 0.9rem;">
